...
export function VehicleFilters({ filtersData }: VehicleFiltersProps) {
  ...
  return (
    <>
      ...
      {/* ── Mobile: bouton + drawer bottom ── */}
      <div className="lg:hidden">
        <button
          onClick={() => setMobileOpen(true)}
          className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium text-white transition-colors hover:border-ar-gold"
