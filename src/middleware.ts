...
export const config = {
  matcher: [
    '/((?!_next/static|_next/image|favicon.ico|api|monitoring|manifest\\.json|sw\\.js|register-sw\\.js|offline\\.html|icons/|sitemap\\.xml|robots\\.txt|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)',
  ],
}
